...
public class AccountSummaryPage extends BasePage{
    ...
    private List<WebElement> columnsOfCreditAccount;
    ...
    public List<String> getColumnNameOfCreditAccount(){
       return BrowserUtils.getElementsText(columnsOfCreditAccount);
    }
