...
public class PayBills_StepDefs {
    ...
    public void user_sends_amount_to_input_box(String amount) {
        payBillsPage.sendAmount(amount);
    }


    @When("User sends {string} date to input box")
    public void user_sends_date_to_input_box(String date) {
      payBillsPage.sendDate(date);
    }


    @When("User sends {string} data to input box")
    public void user_sends_data_to_input_box(String description) {
      payBillsPage.sendDescription(description);
    }
